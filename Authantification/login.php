        ...
        try {
            ...
            if ($user && password_verify($password, $user['password_hash'])) {
                if ($user['status'] !== 'active') {
                    ...
                    // Split full_name for compatibility with existing prenom/nom avatar code
                    $nameParts = explode(' ', $user['full_name'], 2);
                    $_SESSION['user_prenom'] = $nameParts[0] ?? '';
                    $_SESSION['user_nom'] = $nameParts[1] ?? '';
    ...
    <div class="flex-grow flex items-center justify-center p-4 md:p-8 w-full max-w-[1280px] mx-auto border-l-2 border-r-2 border-gray-300">
        <div class="max-w-[1000px] w-full  flex flex-col md:flex-row overflow-hidden relative">
            ...
            <div class="bg-white md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
                ...
                <div class="mt-auto">
                    <p class="text-sm text-stone-600 mb-1">Problems logging in?</p>
            ...
            <div class="md:w-1/2 p-10 md:p-14 flex flex-col justify-center relative z-10 bg-white rounded-t-3xl md:rounded-t-none md:rounded-l-[2.5rem] md:-ml-8 -mt-8 md:mt-0">
                <div class="max-w-xs mx-auto w-full">
                    ...
                    <h2 class="text-3xl font-bold text-center mb-2">Log in</h2>
                    <p class="text-center text-sm text-stone-600 mb-8">
                        Continue to Rondera.<br>
                    ...
                    <form action="login.php" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                <input type="password" id="password" name="password" placeholder="Enter your password" class="w-full px-4 py-3 pr-12 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0063fb] focus:border-transparent transition-all">
                        ...
                        <div class="flex items-center justify-between mb-8">
                            <span class="text-sm font-medium text-stone-800">Remember me</span>
                    ...
                    <div class="text-center text-sm text-stone-800 font-medium">
                        Not registered yet? <a href="register.php" class="text-stone-900 underline hover:no-underline">Create an account</a>
                    </div>

                    <!-- <p class="text-[11px] text-stone-500 mt-8 text-center leading-relaxed">
                        Rondera is a marketplace. You must have a user account to continue. Use the same account across all our services, and manage how we use your data. <a href="#" class="underline">Read our privacy policy</a>.
                    </p> -->
                </div>
            </div>
        </div>
